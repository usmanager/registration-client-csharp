...
using SwaggerDateConverter = Pt.Unl.Fct.Miei.Usmanagement.Manager.Client.SwaggerDateConverter;

namespace Pt.Unl.Fct.Miei.Usmanagement.Manager.Model
{
    /// <summary>
    /// Endpoint
    /// </summary>
    ...
    public partial class Endpoint :  IEquatable<Endpoint>, IValidatableObject
    {
        ...
        public Endpoint(string instanceId = default(string), string endpoint = default(string))
        {
